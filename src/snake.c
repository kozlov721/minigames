...
static int handle_key_events(int rows,
        int cols,
        int h_i,
        int h_j,
        int size,
...
bool is_up(int d_i, int d_j) {
    return d_i == -1 && d_j == 0;
}
bool is_down(int d_i, int d_j) {
    return d_i == 1 && d_j == 0;
}
bool is_left(int d_i, int d_j) {
    return d_i == 0 && d_j == -1;
}
bool is_right(int d_i, int d_j) {
    return d_i == 0 && d_j == 1;
}

int handle_key_events(int rows,
        int cols,
        int h_i,
        int h_j,
        int size,
...
int run_snake(int rows, int cols) {
    ...
    while (true) {
        ...
        if (handle_key_events(rows, cols, h_i, h_j, size, &d_i, &d_j, board))
            break;
